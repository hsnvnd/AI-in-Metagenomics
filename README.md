## Overview
This repository contains the source code for the paper **"Microbiome-Based Classification of Soil Conditions Using Machine Learning and Explainable AI"**. This project implements a Machine Learning pipeline using Linear SVM and Random Forest to classify high-dimensional microbiome data. It leverages Explainable AI (XAI) through SHAP and ShapG to perform feature selection and quantify microbial indicator contributions across multiple sequencing platforms.
